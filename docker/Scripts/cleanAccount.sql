...
DELIMITER //
CREATE OR REPLACE PROCEDURE cleanAccount(IN p_account_id varchar(36))
BEGIN
    DECLARE v_account_record_id bigint /*! unsigned */;
    DECLARE v_tenant_record_id bigint /*! unsigned */;

    select  record_id, tenant_record_id INTO v_account_record_id, v_tenant_record_id from accounts WHERE id = p_account_id  ;
